...
(h, w) = image.shape[:2]
#blob = cv2.dnn.blobFromImage(image, scalefactor=1.0, sizeofneuralnet, mean, swapRB=True)
#scalefactror=1/stdev
...
for i in np.arange(0, detections.shape[2]):
	...
	if confidence > args["confidence"]:
		...
		box = detections[0, 0, i, 3:7] * np.array([w, h, w, h]) #for original size of the image
		#print(box)
